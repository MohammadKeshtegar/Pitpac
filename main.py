...
import img2pdf
import PyPDF4
from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QVBoxLayout, QWidget, QFileDialog, QLabel, QScrollArea, QHBoxLayout, QStackedWidget, QRadioButton
...
class SettingsWindow(QWidget):
    ...
    def initUI(self):        
        ...
        self.toggle = Toggle()
        self.toggle.setChecked(settings.dark_mode)
    ...
    def switch_mode(self, state):
        settings.dark_mode = True if state == 2 else False
...
class MainWindow(QMainWindow):
    ...
    def apply_img_to_pdf_light_style(self):
        self.setStyleSheet("background-color: #e5e5e5; color: #000000")
    ...
    def apply_pdf_combiner_light_style(self):
        ...
        self.back_button.setStyleSheet(self.button_light_style)
        self.scroll_area.setStyleSheet(self.scroll_area_light_style)
        self.pdf_container.setStyleSheet("background-color: #e5e5e5")
